...
import { manifest } from './manifest_BDnLc3vn.mjs';
...
const _page8 = () => import('./pages/api/customer/_id_.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/api/customer/[id].ts", _page8],
...
const _args = {
    "middlewareSecret": "ea561c26-6772-4fca-a955-0a0a9eb930cc"
};
